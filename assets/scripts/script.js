$(document).ready(function(){
    ...
    $('.input_edit button').on('click', function () {
    ...
    // 범용 버튼 클릭 이벤트
    $('[class*="_btn"]').on('click', function (event) {
    ...
    $(".book_mark_open").on("click", function(e) {
    ...
    $(".book_mark .book_close button").on("click", function(e) {
        e.preventDefault(); // 기본 동작 방지
    ...
    $('.head_right button').on('click', function(){
